...
const CancelledSessionsForTeachers = () => {
  ...
  const fetchCancelledSessions = async () => {
    try {
      ...
      const response = await axios.get(`${config.API_URL}/api/sessions/cancelledSessionsForTeachers`, {
        headers: {
          'x-auth-token': token,
        },
      });
  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      const updateListener = DeviceEventEmitter.addListener('updateCancelledSessions', fetchCancelledSessions);
              ...
              <View style={styles.detailsRightContainer}>
                ...
                <View style={styles.teacherContainer}>
                  <View style={styles.teacherItemContainer}>
                    <Text style={styles.teacher}>Student: {item.fullName}</Text>
                  </View>
                </View>
              </View>
            </View>
...
export default CancelledSessionsForTeachers