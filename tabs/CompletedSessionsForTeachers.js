...
const completedSessionsForTeachers = ({ navigation }) => {
  ...
  const fetchCompletedSessions = async () => {
    try {
      ...
      const response = await axios.get(`${config.API_URL}/api/sessions/completedSessionsForTeachers`, {
        headers: {
          'x-auth-token': token,
        },
      });
...
export default completedSessionsForTeachers;