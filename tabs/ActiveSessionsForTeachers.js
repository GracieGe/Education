...
const ActiveSessionsForTeachers = () => {
  ...
  const fetchActiveSessions = async () => {
    try {
      ...
      const response = await axios.get(`${config.API_URL}/api/sessions/activeSessionsForTeachers`, {
        headers: {
          'x-auth-token': token,
        },
      });
...
export default ActiveSessionsForTeachers;